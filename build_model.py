...
import os
from lasagne.layers import InputLayer, DenseLayer, DropoutLayer, FeaturePoolLayer, LocalResponseNormalization2DLayer, BatchNormLayer, prelu, ConcatLayer
...
axial_ch = DropoutLayer(axial_ch, name = 'axial_l1drop', p=0.3)
# channel 2: coronal
